...
public final class VehicleFactory {
    ...
    public Vehicle create(VehicleType vehicleType, @Nullable Route route) {
        ...
        Vehicle vehicle;
        if (prototype.getLabel().equals("Truck"))
        	vehicle = new Truck(prototype.getLabel(), accelerationModel, prototype.getConfiguration(),
                    laneChangeModel);
        else
        	vehicle = new MaopVehicleCorrection(prototype.getLabel(), accelerationModel, prototype.getConfiguration(),
                laneChangeModel);
